...
class TestCore(TestCase):
    ...
    def test_partial(self):
        ...
        self.assertEqual(fields['allocation_policy'].get_spec()['of']['required'], True)
        self.assertEqual(fields['allocation_policy'].get_spec()['of']['of']['required'], True)
        self.assertEqual(fields['epi_config'].required, False)
        self.assertEqual(fields['epi_config'].get_spec()['of']['cycle_duration']['required'], True)
        self.assertEqual(fields['epi_config'].get_spec()['of']['n_cycles']['required'], True)
        self.assertEqual(fields['epi_config'].get_spec()['of']['first_due_delta_days']['required'], True)
